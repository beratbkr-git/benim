  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      t.exports = function t() {
        var e,
          ...
          h = !1;
        for (
          'boolean' == typeof u && ((h = u), (u = arguments[1] || {}), (c = 2)), (null == u || ('object' != typeof u && 'function' != typeof u)) && (u = {});
          c < f;
          ++c
        )
    ...
    function (t, e, n) {
      ...
      function a(t, e, n, r) {
        ...
        if (
          (null != o &&
            (!0 === n && (n = o.index), null == r ? (o = u(o, l, e)) : 0 !== r && (o = u(o, n, r, e)), this.setSelection(o, g.default.sources.SILENT)),
          l.length() > 0)
        ) {
          var a,
          ...
          return (
            ...
            (t.prototype.canAdd = function (t, e) {
              return (
                ...
                (null == this.whitelist || ('string' == typeof e ? this.whitelist.indexOf(e.replace(/["']/g, '')) > -1 : this.whitelist.indexOf(e) > -1))
              );
            }),
        ...
        a = (function () {
          ...
          return (
            (t.prototype.attribute = function (t, e) {
              e
                ? t.add(this.domNode, e) && (null != t.value(this.domNode) ? (this.attributes[t.attrName] = t) : delete this.attributes[t.attrName])
                  ...
                  this.pickers = t.map(function (t) {
                    ...
                    return (
                      null == t.querySelector('option') &&
                        (t.classList.contains('ql-font') ? s(t, P) : t.classList.contains('ql-header') ? s(t, S) : t.classList.contains('ql-size') && s(t, C)),
                      new N.default(t)
                    );
                  });
                  var r = function () {
          ...
          return (
            ...
            (e.prototype.optimize = function (n) {
              t.prototype.optimize.call(this, n),
                ...
                0 === this.text.length
                  ? this.remove()
                  : this.next instanceof e && this.next.prev === this && (this.insertAt(this.length(), this.next.value()), this.next.remove());
            }),
            (e.prototype.position = function (t, e) {
            ...
            case v:
              r + o > 1
                ? (0 !== r &&
                    ...
                    ((e = l(s, i)),
                    0 !== e &&
                      (n - r - o > 0 && t[n - r - o - 1][0] == v ? (t[n - r - o - 1][1] += s.substring(0, e)) : (t.splice(0, 0, [v, s.substring(0, e)]), n++),
                      (s = s.substring(e)),
                      (i = i.substring(e))),
                    0 !== (e = a(s, i)) &&
                      ((t[n][1] = s.substring(s.length - e) + t[n][1]), (s = s.substring(0, s.length - e)), (i = i.substring(0, i.length - e)))),
          ...
          t[n - 1][0] == v &&
            ...
            (t[n][1].substring(t[n][1].length - t[n - 1][1].length) == t[n - 1][1]
              ...
              : t[n][1].substring(0, t[n + 1][1].length) == t[n + 1][1] &&
                ((t[n - 1][1] += t[n + 1][1]), (t[n][1] = t[n][1].substring(t[n + 1][1].length) + t[n + 1][1]), t.splice(n + 1, 1), (c = !0))),
            n++;
        c && u(t);
      }
      function c(t, e) {
    ...
    function (t, e, n) {
      ...
      function l(t, e) {
        return Object.keys(e).reduce(function (n, r) {
          return null == t[r]
            ? n
            : (e[r] === t[r] ? (n[r] = e[r]) : Array.isArray(e[r]) ? e[r].indexOf(t[r]) < 0 && (n[r] = e[r].concat([t[r]])) : (n[r] = [e[r], t[r]]), n);
        }, {});
      }
      function a(t) {
              ...
              },
              {
                ...
                value: function (t, n, r, o) {
                  (null == this.whitelist || this.whitelist[r]) &&
                    (c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'formatAt', this).call(this, t, n, r, o), this.optimize());
                },
              },
              {
                key: 'insertAt',
            ...
            a(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  this.cachedText !== e &&
                    ((e.trim().length > 0 || null == this.cachedText) && ((this.domNode.innerHTML = t(e)), this.domNode.normalize(), this.attach()),
                    (this.cachedText = e));
                },
              },
            ]),
