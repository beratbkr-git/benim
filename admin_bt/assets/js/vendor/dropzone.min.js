      ...
      return (
        ...
        !1 !== n.options.previewsContainer &&
          (n.options.previewsContainer
            ? (n.previewsContainer = C.getElement(n.options.previewsContainer, 'previewsContainer'))
            : (n.previewsContainer = n.element)),
        n.options.clickable &&
          (!0 === n.options.clickable ? (n.clickableElements = [n.element]) : (n.clickableElements = C.getElements(n.options.clickable, 'clickable'))),
        n.init(),
        n
      );
    }
                    ...
                    var h = function (e) {
                        return (
                          ...
                          t.status === C.UPLOADING
                            ? C.confirm(n.options.dictCancelUploadConfirmation, function () {
                                return n.removeFile(t);
                              })
                            : n.options.dictRemoveFileConfirmation
                            ? C.confirm(n.options.dictRemoveFileConfirmation, function () {
                                return n.removeFile(t);
                              })
                            : n.removeFile(t)
                        );
      ...
      _createClass(
        ...
        [
              ...
              if (
                ...
                this.element.classList.contains('dropzone') &&
                  ...
                  this.element.appendChild(
                    C.createElement(
                      '<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, '</button></div>'),
                    ),
                  ),
                ...
                !(function l() {
                  return (
                    s.hiddenFileInput && s.hiddenFileInput.parentNode.removeChild(s.hiddenFileInput),
                ...
                this.clickableElements.forEach(function (t) {
                  return s.listeners.push({
                    ...
                    events: {
                      click: function (e) {
                        return (
                          (t === s.element && e.target !== s.element && !C.elementInside(e.target, s.element.querySelector('.dz-message'))) ||
            ...
            value: function () {
              ...
              this.options.dictFallbackText && (n += '<p>'.concat(this.options.dictFallbackText, '</p>')),
                (n += '<input type="file" name="'
                  ...
                  .concat(this.options.uploadMultiple ? 'multiple="multiple"' : void 0, ' /><input type="submit" value="Upload!"></div>'));
              var i = C.createElement(n);
              return (
                'FORM' !== this.element.tagName
                  ? (t = C.createElement(
                      '<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'),
                    )).appendChild(i)
                  ...
                  for (var r, o = s[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                    ...
                    null != l.webkitGetAsEntry && (a = l.webkitGetAsEntry())
                      ? a.isFile
                        ...
                        : e.push(void 0)
                      : null != l.getAsFile && (null == l.kind || 'file' === l.kind)
                      ? e.push(u.addFile(l.getAsFile()))
                      : e.push(void 0);
                  }
                } catch (e) {
          ...
          },
          {
            ...
            value: function (t) {
              var n = this;
              (t.upload = {uuid: C.uuidv4(), progress: 0, total: t.size, bytesSent: 0, filename: this._renameFile(t)}),
                this.files.push(t),
                (t.status = C.ADDED),
          ...
          },
          {
            ...
            value: function (e) {
              if (
                (e.status === C.UPLOADING && this.cancelUpload(e), (this.files = without(this.files, e)), this.emit('removedfile', e), 0 === this.files.length)
              )
            ...
            value: function (e) {
              if (e.status === C.UPLOADING) {
                ...
                (e.status !== C.ADDED && e.status !== C.QUEUED) ||
                  ((e.status = C.CANCELED), this.emit('canceled', e), this.options.uploadMultiple && this.emit('canceledmultiple', [e]));
                ...
                if (s[0].upload.chunked) {
                  ...
                  var i = function () {
                    ...
                    if (!(e >= r.upload.totalChunkCount)) {
                      ...
                      (r.upload.chunks[e] = {file: r, index: e, dataBlock: i, status: C.UPLOADING, progress: 0, retries: 0}), u._uploadData(s, [i]);
                    }
                  };
                  if (
            ...
            value: function (e, t, n) {
              ...
              if (e[0].status !== C.CANCELED && 4 === t.readyState) {
                if (
                  ...
                  'blob' !== t.responseType &&
                  ((i = t.responseText), t.getResponseHeader('content-type') && ~t.getResponseHeader('content-type').indexOf('application/json'))
                )
                  try {
                    i = JSON.parse(i);
                  } catch (e) {
