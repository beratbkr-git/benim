...
var FullCalendar = (function (e) {
  ...
  function xn(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Pn(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {typeId: u.typeId, typeData: u.typeData, duration: u.duration}),
        {def: c, instance: null}
      );
    var c,
      d = (function (e, t, n, r) {
        ...
        u
          ? (l = !0)
          : r ||
            ((l = n.options.forceEventDuration || !1), (u = n.dateEnv.add(s, a ? n.options.defaultAllDayEventDuration : n.options.defaultTimedEventDuration)));
        return {allDay: a, hasEnd: l, range: {start: s, end: u}, forcedStartTzo: o ? o.forcedTzo : null, forcedEndTzo: i ? i.forcedTzo : null};
      })(a, l, n, r);
    return d ? {def: (c = Pn(a, s, t ? t.sourceId : '', d.allDay, d.hasEnd, n)), instance: pt(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo)} : null;
  }
  function Mn(e, t, n) {
  ...
  function Er(e, t, n) {
    ...
    if (
      (void 0 === n && (n = Sr(t)),
      'string' == typeof e ? (r = {url: e}) : 'function' == typeof e || Array.isArray(e) ? (r = {events: e}) : 'object' == typeof e && e && (r = e),
      r)
    ) {
      var o = pn(r, n),
        i = o.refined,
      ...
      return (
        ...
        (e.prototype.changeView = function (e, t) {
          ...
          this.batchRendering(function () {
            if ((n.unselect(), t))
              if (t.start && t.end)
                n.dispatch({type: 'CHANGE_VIEW_TYPE', viewType: e}), n.dispatch({type: 'SET_OPTION', optionName: 'visibleRange', rawOptionValue: t});
              else {
        ...
        (e.prototype.addEventSource = function (e) {
          var t = this.getCurrentData();
          if (e instanceof ye)
            return t.eventSources[e.internalEventSource.sourceId] || this.dispatch({type: 'ADD_EVENT_SOURCES', sources: [e.internalEventSource]}), e;
          var n = Er(e, t);
  ...
  function Mr(e) {
    ...
    if (t) {
      ...
      if (ct(n)) {
        var r = null;
        return (
          t[13] && (r = ('-' === t[15] ? -1 : 1) * (60 * Number(t[16] || 0) + Number(t[18] || 0))), {marker: n, isTimeUnspecified: !t[6], timeZoneOffset: r}
        );
      }
    }
    return null;
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(zo, {hookProps: n, didMount: t.didMount, willUnmount: t.willUnmount, elRef: this.handleRootEl}, function (r) {
            return mo(Vo, {hookProps: n, content: t.content, defaultContent: t.defaultContent, backupElRef: e.rootElRef}, function (e, o) {
    ...
    return (
      ...
      (e.prototype.adjustActiveRange = function (e) {
        var t = this.props,
          ...
          a = e.start,
          s = e.end;
        return r && (Pt(o) < 0 && ((a = rt(a)), (a = n.add(a, o))), Pt(i) > 1 && ((s = Ke((s = rt(s)), -1)), (s = n.add(s, i)))), {start: a, end: s};
      }),
            ...
            if (e.daysOfWeek || e.startTime || e.endTime || e.startRecur || e.endRecur) {
              ...
              return (
                ...
                !r &&
                  ...
                  ((o = e.endTime),
                  (i = e.startTime),
                  (r = {years: o.years - i.years, months: o.months - i.months, days: o.days - i.days, milliseconds: o.milliseconds - i.milliseconds})),
  ...
  function Pi(e) {
    ...
    return {
      ...
      selectionConfig: Cn({constraint: t.selectConstraint, overlap: 'boolean' == typeof t.selectOverlap ? t.selectOverlap : void 0, allow: t.selectAllow}, e),
    };
  }
  function Ni(e, t) {
      ...
      return (
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          ...
          return (
            ...
            i
              ? (n.push.apply(n, o([r(r({}, e), {spanStart: Math.max(t.spanStart, e.spanStart), spanEnd: Math.min(t.spanEnd, e.spanEnd)})], a)), i)
              : (n.push(e), 0)
          );
        }),
    ...
    for (var t = [], n = 0, r = e; n < r.length; n++) {
      for (var o = r[n], i = [], a = {spanStart: o.spanStart, spanEnd: o.spanEnd, entries: [o]}, s = 0, l = t; s < l.length; s++) {
        ...
        u.spanStart < a.spanEnd && u.spanEnd > a.spanStart
          ? (a = {spanStart: Math.min(u.spanStart, a.spanStart), spanEnd: Math.max(u.spanEnd, a.spanEnd), entries: u.entries.concat(a.entries)})
          : i.push(u);
      }
      i.push(a), (t = i);
    }
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e; s < l.length; s++) {
            ...
            if ('title' === c) (a = !1), i.push(mo('h2', {className: 'fc-toolbar-title'}, t.title));
              ...
              i.push(mo('button', r({disabled: g, className: v.join(' '), onClick: d, type: 'button'}, h), p || (f ? mo('span', {className: f}) : '')));
            }
          }
          if (i.length > 1) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            mo('div', {ref: this.handleEl, onClick: e.onClick, className: r.join(' '), style: {height: o, paddingBottom: i}}, e.children)
          );
        }),
        (t.prototype.componentDidMount = function () {
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              ...
              o.emitter.trigger('eventClick', {el: t, event: new Cr(r.context, i.eventRange.def, i.eventRange.instance), jsEvent: e, view: o.viewApi}),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            mo(ea, {liquid: a, height: s, aspectRatio: e, onClick: this.handleNavLinkClick}, this.renderView(t), this.buildAppendContent()),
  ...
  function oa(e, t, n, r, o, i) {
    var a = n.build(o, void 0, !1),
      s = n.buildPrev(t, r, !1),
      l = n.buildNext(t, r, !1);
    return {title: i, activeButton: e.type, isTodayEnabled: a.isValid && !Bn(t.currentRange, o), isPrevEnabled: s.isValid, isNextEnabled: l.isValid};
  }
  function ia(e) {
  ...
  function sa(e, t) {
    return nn(!e || t > 10 ? {weekday: 'short'} : t > 1 ? {weekday: 'short', month: 'numeric', day: 'numeric', omitCommas: !0} : {weekday: 'long'});
  }
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            function (e, t, n, o) {
              return mo(
                'th',
                r({ref: e, className: c.concat(t).join(' '), 'data-date': u.isDisabled ? void 0 : Ut(s), colSpan: a.colSpan}, a.extraDataAttrs),
                mo(
                  'div',
                  {className: 'fc-scrollgrid-sync-inner'},
                  !u.isDisabled && mo('a', r({ref: n, className: ['fc-col-header-cell-cushion', a.isSticky ? 'fc-sticky' : ''].join(' ')}, p), o),
                ),
              );
            },
          );
    ...
    pa = (function (e) {
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (i = Math.min(864e5, i)), {currentState: {nowDate: r, todayRange: fa(r)}, nextState: {nowDate: o, todayRange: fa(o)}, waitMs: i};
        }),
  ...
  var ga = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r; ) t.isHiddenDay(n) ? o.push(a + 0.5) : ((a += 1), o.push(a), i.push(n)), (n = Ke(n, 1));
  ...
  function Ya(e) {
    return mo(
      ...
      mo('div', {className: 'fc-event-title-container'}, mo('div', {className: 'fc-event-title fc-sticky'}, e.event.title || mo(So, null, ' '))),
    );
  }
  var Za = function (e) {
          ...
          (t.handleClick = function (e) {
            ...
            function s(e) {
              var t = e.eventRange,
                ...
                r = t.instance,
                i = t.range;
              return {event: new Cr(o, n, r), start: o.dateEnv.toDate(i.start), end: o.dateEnv.toDate(i.end), isStart: e.isStart, isEnd: e.isEnd};
            }
            'function' == typeof i &&
              (i = i({date: a, allDay: Boolean(r.allDayDate), allSegs: r.allSegs.map(s), hiddenSegs: r.hiddenSegs.map(s), jsEvent: e, view: o.viewApi})),
          ...
          if (o.isRendering) {
            ...
            yo(
              mo(aa, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, function (t, n, i, a) {
                return o.setClassNames(t), o.setHeight(n), mo(Wo.Provider, {value: o.customContentRenderId}, mo(ra, r({isHeightAuto: i, forPrint: a}, e)));
              }),
              o.el,
            );
      ...
      return (
        ...
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !Se(n, this.handleSelector))) && ((this.subjectEl = t), (this.isDragging = !0), (this.wasTouchScroll = !1), !0)
          );
        }),
        ...
        (e.prototype.recordCoords = function (e) {
          this.shouldWatchScroll &&
            ((this.prevPageX = e.pageX), (this.prevPageY = e.pageY), (this.prevScrollX = window.pageXOffset), (this.prevScrollY = window.pageYOffset));
        }),
          ...
          (r.onPointerDown = function (e) {
            r.isDragging ||
              ...
              r.isInteracting &&
                ...
                (r.mirror.setIsVisible(!1), r.mirror.start(e.subjectEl, e.pageX, e.pageY), r.startDelay(e), r.minDistance || r.handleDistanceSurpassed(e)));
          }),
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            i ? o.dispatch({type: 'SELECT_DATES', selection: i}) : t || o.dispatch({type: 'UNSELECT_DATES'}), a ? He() : Oe(), t || (n.dragSelection = i);
          }),
        ...
        (o.handleDragStart = function (e) {
          ...
          e.isTouch ? r !== o.component.props.eventSelection && t.dispatch({type: 'SELECT_EVENT', eventInstanceId: r}) : t.dispatch({type: 'UNSELECT_EVENT'}),
            o.isDragging &&
              ...
              t.emitter.trigger('eventDragStart', {el: o.subjectEl, event: new Cr(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi}));
        }),
            ...
            if ((o.clearDrag(), t.emitter.trigger('eventDragStop', {el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n}), s)) {
              if (a === t) {
                ...
                a.emitter.trigger('eventAdd', w),
                  ...
                  a.emitter.trigger('drop', r(r({}, ks(f.dateSpan, a)), {draggedEl: e.subjectEl, jsEvent: e.origEvent, view: f.context.viewApi})),
    ...
    return (
      ...
      (t.prototype.displayDrag = function (e, t) {
        ...
        r &&
          r !== e &&
          (r === n
            ? r.dispatch({type: 'SET_EVENT_DRAG', state: {affectedEvents: t.affectedEvents, mutatedEvents: {defs: {}, instances: {}}, isEvent: !0}})
          ...
          (this.handleDragEnd = function (e) {
            ...
            if ((n.clearDrag(), o && i)) {
              var a = n.hitDragging.finalHit,
                s = a.context.viewApi,
                l = n.dragMeta;
              if ((o.emitter.trigger('drop', r(r({}, ks(a.dateSpan, o)), {draggedEl: e.subjectEl, jsEvent: e.origEvent, view: s})), l.create)) {
                var u = vn(i);
  ...
  var Us = (function () {
    ...
    Ls = (function (e) {
      function t(t) {
        ...
        return (
          r.emitter.on('pointerdown', n.handlePointerDown), r.emitter.on('pointermove', n.handlePointerMove), r.emitter.on('pointerup', n.handlePointerUp), n
        );
      }
      return (
        n(t, e),
    ...
    Vs = Ho({componentInteractions: [xs, Ms, Is, Ps], calendarInteractions: [Ns], elementDraggingImpl: ws, optionRefiners: Hs, listenerRefiners: Os}),
    Fs = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
          ...
          return (
            ...
            mo(qo, {viewSpec: a.viewSpec}, function (e, t) {
              return mo(
                'div',
                {ref: e, className: ['fc-daygrid'].concat(t).join(' ')},
                mo(o, {liquid: !i.isHeightAuto && !i.forPrint, collapsibleWidth: i.forPrint, colGroups: [{cols: [{span: n, minWidth: r}]}], sections: u}),
              );
            })
          );
        }),
      ...
      (t.prototype.render = function () {
        ...
        return mo(
          ...
          function (n, o) {
            return (
              (o || e.forceDayTop) &&
              mo('div', {className: 'fc-daygrid-day-top', ref: n}, mo('a', r({className: 'fc-daygrid-day-number'}, t), o || mo(So, null, ' ')))
            );
          },
        );
      }),
              ...
              return mo(
                ...
                n.map(function (n) {
                  ...
                  return mo(
                    ...
                    Zs(n)
                      ? mo(Ks, r({seg: n, isDragging: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1}, nr(n, e.todayRange)))
                      : mo(
                          Xs,
                          r(
                            {seg: n, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1},
                            nr(n, e.todayRange),
                          ),
                        ),
                  );
    ...
    tl = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            Ja,
            {date: a, dateProfile: s, todayRange: t.todayRange, showDayNumber: t.showDayNumber, extraHookProps: t.extraHookProps, elRef: this.handleRootEl},
            function (e, n, i, u) {
              return mo(
                'td',
  ...
  function nl(e, t, n, r, o, i, a) {
    ...
    for (
        ...
        f = (function (e, t, n) {
          for (
            ...
            for (var l = r[s], u = [], c = 0, d = 0, p = 0, f = l; p < f.length; p++) {
              ...
              u.push({seg: rl(h, s, s + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: y.levelCoord - c}), (c = y.levelCoord + y.thickness);
            }
            var v = [];
            (c = 0), (d = 0);
            for (var g = 0, m = l; g < m.length; g++) {
              ...
              (d += y.levelCoord - c),
                ...
                E
                  ? ((d += y.thickness),
                    S && v.push({seg: rl(h, y.spanStart, y.spanEnd, n), isVisible: !0, isAbsolute: !0, absoluteTop: y.levelCoord, marginTop: 0}))
                  : S && (v.push({seg: rl(h, y.spanStart, y.spanEnd, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: d}), (d = 0));
            }
      ...
      for (var D = R.firstCol; D <= R.lastCol; D += 1) h[D].push({seg: rl(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0});
    }
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            c = nl(Kn(n.fgEventSegs, o.eventOrder), n.dayMaxEvents, n.dayMaxEventRows, o.eventOrderStrict, r.eventInstanceHeights, r.maxContentHeight, n.cells),
                ...
                f.push(
                  mo(
                    ...
                    Zs(m)
                      ...
                      : mo(Xs, r({seg: m, isDragging: i, isResizing: a, isDateSelecting: s, isSelected: y === u, defaultDisplayEventEnd: d}, nr(m, n))),
                  ),
                );
            }
          return f;
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          if (a)
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                mo('div', {key: or(c.eventRange), className: 'fc-daygrid-bg-harness', style: d}, 'bg-event' === t ? mo(es, r({seg: c}, nr(c, i))) : Qa(t)),
              );
            }
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            a = n.dayHeaders && mo(ha, {ref: this.headerRef, dateProfile: o.dateProfile, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt}),
            s = function (t) {
              return mo(ul, {
                ref: e.tableRef,
              ...
              ? mo(ns, {date: i.start, defaultFormat: yl}, function (e, t, o, i) {
                  return mo(
                    ...
                    mo(
                      ...
                      mo('a', r({ref: o, className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner'}, s), i),
                    ),
                  );
                })
              ...
              chunks: [
                {
                  ...
                  content: function (e) {
                    return mo(
                      ...
                      mo('table', {style: {height: e.expandRows ? e.clientHeight : ''}}, e.tableColGroupNode, mo('tbody', null, mo(ml, {slatMetas: i}))),
                      mo(
                        'div',
                        ...
                        mo(pa, {unit: h ? 'minute' : 'day'}, function (e) {
                          ...
                          return 'number' == typeof t
                            ? mo(Za, {isAxis: !0, date: e}, function (e, n, r, o) {
                                return mo('div', {ref: e, className: ['fc-timegrid-now-indicator-arrow'].concat(n).join(' '), style: {top: t}}, o);
                              })
                            : null;
                        }),
                      ),
            ...
            function (o, i) {
              var a = xl(
                  (function (e, t, n) {
                    ...
                    for (; l < s; l += 1) {
                      for (var u = o[l], c = void 0, d = Bi(u, i.spanStart, Wi), p = d[0] + d[1], f = p; (c = u[f]) && c.spanStart < i.spanEnd; ) f += 1;
  ...
  var Nl = nn({hour: 'numeric', minute: '2-digit', meridiem: !1}),
    Hl = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return this.props.isShort && e.push('fc-timegrid-event-short'), mo(qa, r({}, this.props, {defaultTimeFormat: Nl, extraClassNames: e}));
        }),
        t
      );
    })(xo),
    Ol = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props;
          return mo(Ka, {date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, extraHookProps: e.extraHookProps}, function (e, t) {
            ...
            function (n, l, u) {
              return mo(
                ...
                mo(
                  ...
                  mo('div', {className: 'fc-timegrid-col-events'}, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))),
          ...
          return mo(
            ...
            y.map(function (s) {
              ...
              return mo(
                ...
                mo(Hl, r({seg: l, isDragging: n, isResizing: o, isDateSelecting: i, isSelected: c === p, isShort: s.spanEnd - s.spanStart < u}, nr(l, f, h))),
              );
            }),
          );
        }),
          ...
          return n
            ? e.map(function (e, t) {
                return mo(Za, {isAxis: !1, date: r, key: t}, function (t, o, i, a) {
                  return mo('div', {ref: t, className: ['fc-timegrid-now-indicator-line'].concat(o).join(' '), style: {top: n.computeDateTop(e.start, r)}}, a);
                });
              })
            : null;
        }),
                      ...
                      mo(
                        ...
                        'number' == typeof n &&
                          mo(Za, {isAxis: !0, date: t.nowDate}, function (e, t, r, o) {
                            return mo('div', {ref: e, className: ['fc-timegrid-now-indicator-arrow'].concat(t).join(' '), style: {top: n}}, o);
                          }),
                      ),
                    ),
                  ),
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          p = !d,
          f = d,
          h = n.dayHeaders && mo(ha, {dates: l.headerDates, dateProfile: s, datesRepDistinctDays: !0, renderIntro: p ? this.renderHeadAxis : null}),
          v =
            !1 !== n.allDaySlot &&
            function (t) {
              return mo(
    ...
    return (
      ...
      (t.prototype.renderEmptyMessage = function () {
        ...
        return mo(
          ...
          function (e, t, n, r) {
            return mo('div', {className: ['fc-list-empty'].concat(t).join(' '), ref: e}, mo('div', {className: 'fc-list-empty-cushion', ref: n}, r));
          },
        );
      }),
              ...
              for (var d = 0, p = (u = Kn(u, i.eventOrder)); d < p.length; d++) {
                ...
                s.push(
                  mo(
                    Jl,
                    r(
                      {key: c + ':' + f.eventRange.instance.instanceId, seg: f, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1},
                      nr(f, n, e),
                    ),
                  ),
                );
  ...
  function ru(e) {
    for (var t = rt(e.renderRange.start), n = e.renderRange.end, r = [], o = []; t < n; ) r.push(t), o.push({start: t, end: Ke(t, 1)}), (t = Ke(t, 1));
  ...
  var iu = Ho({
      optionRefiners: {listDayFormat: ou, listDaySideFormat: ou, noEventsClassNames: fn, noEventsContent: fn, noEventsDidMount: fn, noEventsWillUnmount: fn},
      views: {
  ...
  (au.prototype.classes = {
    ...
    (au.prototype.rtlIconClasses = {prev: 'fa-chevron-right', next: 'fa-chevron-left', prevYear: 'fa-angle-double-right', nextYear: 'fa-angle-double-left'}),
    ...
    (e.getSlotClassNames = function (e, t) {
      ...
      return (
        e.isDisabled
          ...
          : (e.isToday && (n.push('fc-slot-today'), n.push(t.getClass('today'))), e.isPast && n.push('fc-slot-past'), e.isFuture && n.push('fc-slot-future')),
        n
      );
    }),
