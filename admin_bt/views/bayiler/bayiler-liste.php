...
// AJAX endpointleri
$liste_ajax_url = "/{$yonetimurl}/bayiler/listele";
$sil_ajax_url = "/{$yonetimurl}/bayiler/sil";
?>
<main>
    <div class="container">
        <div class="row">
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Bayi Yönetimi</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="Bayilerde Ara..." data-datatable="#bayilerDatatable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                <!-- Print Button Start -->
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow datatable-print" data-datatable="#bayilerDatatable" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Yazdır" type="button">
                                    <i data-acorn-icon="print"></i>
                                </button>
                                <!-- Print Button End -->
                                <!-- Export Dropdown Start -->
                                <div class="d-inline-block datatable-export" data-datatable="#bayilerDatatable">
                            ...
                            <!-- Length Start -->
                            <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#bayilerDatatable" data-childSelector="span">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Seçili Bayileri Sil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">Seçili bayileri kalıcı olarak silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</div>
...
<script>
    const bayilerConfig = {
        tableSelector: '#bayilerDatatable',
        api: {
            read: '<?= $liste_ajax_url ?>',
            delete: '<?= $sil_ajax_url ?>'
        },
        columns: [{ // 0 - ID
            ...
            { // 1 - Firma Adı
                ...
                render: function(data, type, row) {
                    return `<a href="/<?= $yonetimurl ?>/bayiler/detay/${row.id}" class="list-item-heading body fw-bold">${data}</a>`;
                }
            },
            { // 2 - Bayi (Kullanıcı Adı)
                data: 'ad_soyad',
                title: 'Bayi',
                render: function(data, type, row) {
                    return data ? `${data} <br><small class="text-muted">${row.eposta}</small>` : '<span class="text-muted">Kullanıcı Yok</span>';
                }
            },
            { // 3 - Komisyon
                data: 'komisyon_orani',
            ...
            { // 5 - İşlemler
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/<?= $yonetimurl ?>/bayiler/detay/${row.id}" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof ServerSideDataTable !== 'undefined') {
            new ServerSideDataTable(bayilerConfig);
        } else {
