...
// AJAX endpointleri
$liste_ajax_url = "/{$yonetimurl}/kategoriler/listele";
$sil_ajax_url = "/{$yonetimurl}/kategoriler/sil";
$durum_guncelle_ajax_url = "/{$yonetimurl}/kategoriler/ajax-guncelle";
?>
<main>
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Kategori Yönetimi</h1>
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            <a href="/<?= $yonetimurl ?>/kategoriler/ekle" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
                ...
                <div class="data-table-rows slim">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="Kategorilerde Ara..." data-datatable="#kategorilerDatatable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                <!-- Print Button Start -->
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow datatable-print" data-datatable="#kategorilerDatatable" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Yazdır" type="button">
                                    <i data-acorn-icon="print"></i>
                                </button>
                                <!-- Print Button End -->
                                <!-- Export Dropdown Start -->
                                <div class="d-inline-block datatable-export" data-datatable="#kategorilerDatatable">
                            ...
                            <!-- Length Start -->
                            <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#kategorilerDatatable" data-childSelector="span">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="kategorilerDatatable" class="data-table nowrap hover">
                            <thead>
                                <tr>
                                    <th class="text-muted text-small text-uppercase">ID</th>
                                    <th class="text-muted text-small text-uppercase">Görsel</th>
                                    <th class="text-muted text-small text-uppercase">Kategori Adı</th>
                                    <th class="text-muted text-small text-uppercase">Üst Kategori</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Seçili Kategorileri Sil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">Seçili kategorileri kalıcı olarak silmek istediğinizden emin misiniz? Alt kategoriler de silinecektir. Bu işlem geri alınamaz.</div>
...
<script>
    const kategorilerConfig = {
        tableSelector: '#kategorilerDatatable',
        api: {
            read: '<?= $liste_ajax_url ?>',
            delete: '<?= $sil_ajax_url ?>',
        ...
        columns: [{ // 0 - ID ve Gizli Checkbox
            ...
            { // 2 - Kategori Adı
                ...
                title: 'Kategori Adı',
                render: function(data, type, row) {
                    return `<a href="/<?= $yonetimurl ?>/kategoriler/duzenle/${row.id}" class="list-item-heading body fw-bold">${data}</a>`;
                }
            },
            { // 3 - Üst Kategori
                data: 'ust_kategori_adi',
                title: 'Üst Kategori',
                render: function(data, type, row) {
            ...
            { // 6 - İşlemler
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/<?= $yonetimurl ?>/kategoriler/duzenle/${row.id}" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof ServerSideDataTable !== 'undefined') {
            new ServerSideDataTable(kategorilerConfig);
        } else {
