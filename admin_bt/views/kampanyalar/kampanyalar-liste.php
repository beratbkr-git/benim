...
// AJAX endpointleri
$liste_ajax_url = "/{$yonetimurl}/kampanyalar/listele";
$sil_ajax_url = "/{$yonetimurl}/kampanyalar/sil";
$durum_guncelle_ajax_url = "/{$yonetimurl}/kampanyalar/ajax-guncelle";
            ...
            <div class="col">
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Kampanya Yönetimi</h1>
                            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="/<?= $yonetimurl ?>">Panel Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="/<?= $yonetimurl ?>/kampanyalar/liste">Kampanyalar</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!-- Title End -->
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            <a href="/<?= $yonetimurl ?>/kampanyalar/ekle" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
                ...
                <div class="data-table-rows slim">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="Kampanyalarda Ara..." data-datatable="#kampanyaDatatable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                <!-- Print Button Start -->
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow datatable-print" data-datatable="#kampanyaDatatable" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Yazdır" type="button">
                                    <i data-acorn-icon="print"></i>
                                </button>
                                <!-- Print Button End -->
                                <!-- Export Dropdown Start -->
                                <div class="d-inline-block datatable-export" data-datatable="#kampanyaDatatable">
                            ...
                            <!-- Length Start -->
                            <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#kampanyaDatatable" data-childSelector="span">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="kampanyaDatatable" class="data-table nowrap hover">
                            <thead>
                                <tr>
                                    <th class="text-muted text-small text-uppercase">ID</th>
                                    <th class="text-muted text-small text-uppercase">Kampanya Adı</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Seçili Kampanyaları Sil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">Seçili kampanyaları kalıcı olarak silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</div>
...
<script>
    const kampanyalarConfig = {
        tableSelector: '#kampanyaDatatable',
        api: {
            read: '<?= $liste_ajax_url ?>',
            delete: '<?= $sil_ajax_url ?>',
        ...
        columns: [{ // 0 - ID ve Gizli Checkbox
            ...
            { // 1 - Kampanya Adı
                ...
                title: 'Kampanya Adı',
                render: function(data, type, row) {
                    return `<a href="/<?= $yonetimurl ?>/kampanyalar/duzenle/${row.id}" class="list-item-heading body fw-bold">${data}</a>`;
                }
            },
            { // 2 - İndirim
                data: 'indirim_degeri',
            ...
            { // 3 - Geçerlilik
                ...
                render: function(data, type, row) {
                    const now = new Date();
                    const baslangicTarihi = new Date(row.baslangic_tarihi);
                    const bitisTarihi = row.bitis_tarihi ? new Date(row.bitis_tarihi) : null;
                    if (bitisTarihi && bitisTarihi < now) {
                        return `<span class="text-danger">Süresi Dolmuş</span>`;
                    }
                    if (baslangicTarihi > now) {
                        return `<span class="text-warning">Başlamadı</span>`;
                    }
                    return `${baslangicTarihi.toLocaleDateString('tr-TR')} - ${bitisTarihi ? bitisTarihi.toLocaleDateString('tr-TR') : 'Süresiz'}`;
                }
            },
            { // 4 - Durum
                data: 'durum',
            ...
            { // 5 - İşlemler
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/<?= $yonetimurl ?>/kampanyalar/duzenle/${row.id}" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof ServerSideDataTable !== 'undefined') {
            new ServerSideDataTable(kampanyalarConfig);
        } else {
