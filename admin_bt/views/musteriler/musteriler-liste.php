...
// AJAX endpointleri
$liste_ajax_url = "/{$yonetimurl}/musteriler/listele";
$sil_ajax_url = "/{$yonetimurl}/musteriler/sil";
?>
<main>
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Müşteri Yönetimi</h1>
                ...
                <div class="data-table-rows slim">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="Müşterilerde Ara..." data-datatable="#musterilerDatatable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                <!-- Print Button Start -->
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow datatable-print" data-datatable="#musterilerDatatable" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Yazdır" type="button">
                                    <i data-acorn-icon="print"></i>
                                </button>
                                <!-- Print Button End -->
                                <!-- Export Dropdown Start -->
                                <div class="d-inline-block datatable-export" data-datatable="#musterilerDatatable">
                            ...
                            <!-- Length Start -->
                            <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#musterilerDatatable" data-childSelector="span">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="musterilerDatatable" class="data-table nowrap hover">
                            <thead>
                                <tr>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Seçili Müşterileri Sil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">Seçili müşterileri kalıcı olarak silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</div>
...
<script>
    const musterilerConfig = {
        tableSelector: '#musterilerDatatable',
        api: {
            read: '<?= $liste_ajax_url ?>',
            delete: '<?= $sil_ajax_url ?>'
        },
        columns: [{ // 0 - ID
            ...
            { // 1 - Ad Soyad
                ...
                render: function(data, type, row) {
                    return `<a href="/<?= $yonetimurl ?>/musteriler/detay/${row.id}" class="list-item-heading body fw-bold">${data}</a>`;
                }
            },
            { // 2 - E-posta
                data: 'eposta',
            ...
            { // 5 - İşlemler
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/<?= $yonetimurl ?>/musteriler/detay/${row.id}" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start">
        ...
        customOptions: {
            order: [
                [4, "desc"]
            ] // Varsayılan olarak son giriş tarihine göre sırala
        }
    };

    document.addEventListener('DOMContentLoaded', function() {
        if (typeof ServerSideDataTable !== 'undefined') {
            new ServerSideDataTable(musterilerConfig);
        } else {
