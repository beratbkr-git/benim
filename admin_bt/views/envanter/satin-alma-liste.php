...
// AJAX endpointleri
$liste_ajax_url = "/{$yonetimurl}/envanter/listele-satin-alma";
$sil_ajax_url = "/{$yonetimurl}/envanter/sil-satin-alma";
?>
<main>
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Satın Alma Siparişleri</h1>
                            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="/<?= $yonetimurl ?>">Panel Anasayfa</a></li>
                                    <li class="breadcrumb-item"><a href="/<?= $yonetimurl ?>/envanter/satin-alma-liste">Envanter & Stok</a></li>
                                    <li class="breadcrumb-item active">Satın Alma Siparişleri</li>
                                </ul>
                            </nav>
                        </div>
                        <!-- Title End -->
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            <a href="/<?= $yonetimurl ?>/envanter/satin-alma-ekle" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
                ...
                <div class="data-table-rows slim">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="Siparişlerde Ara..." data-datatable="#satinAlmaDatatable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                <!-- Print Button Start -->
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow datatable-print" data-datatable="#satinAlmaDatatable" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-delay="0" title="Yazdır" type="button">
                                    <i data-acorn-icon="print"></i>
                                </button>
                                <!-- Print Button End -->
                                <!-- Export Dropdown Start -->
                                <div class="d-inline-block datatable-export" data-datatable="#satinAlmaDatatable">
                            ...
                            <!-- Length Start -->
                            <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#satinAlmaDatatable" data-childSelector="span">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="satinAlmaDatatable" class="data-table nowrap hover">
                            <thead>
                                <tr>
                                    <th class="text-muted text-small text-uppercase">ID</th>
                                    <th class="text-muted text-small text-uppercase">Sipariş No</th>
                                    <th class="text-muted text-small text-uppercase">Tedarikçi</th>
                                    <th class="text-muted text-small text-uppercase">Toplam Tutar</th>
                                    <th class="text-muted text-small text-uppercase">Durum</th>
                                    <th class="text-muted text-small text-uppercase">Sipariş Tarihi</th>
                                    <th class="empty">&nbsp;</th>
                                </tr>
                            </thead>
                        </table>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Seçili Siparişleri Sil</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">Seçili satın alma siparişlerini kalıcı olarak silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</div>
...
<script>
    const satinAlmaConfig = {
        tableSelector: '#satinAlmaDatatable',
        api: {
            read: '<?= $liste_ajax_url ?>',
            delete: '<?= $sil_ajax_url ?>',
        },
        columns: [{ // 0 - ID
            ...
            { // 1 - Sipariş No
                ...
                title: 'Sipariş No',
                render: function(data, type, row) {
                    return `<a href="/<?= $yonetimurl ?>/envanter/satin-alma-duzenle/${row.id}" class="list-item-heading body fw-bold">${data}</a>`;
                }
            },
            { // 2 - Tedarikçi
                data: 'firma_adi',
            ...
            { // 6 - İşlemler
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/<?= $yonetimurl ?>/envanter/satin-alma-duzenle/${row.id}" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof ServerSideDataTable !== 'undefined') {
            new ServerSideDataTable(satinAlmaConfig);
        } else {
